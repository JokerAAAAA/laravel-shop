...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Laravel-admin html titleLaravel-Admin 页面标题
    |--------------------------------------------------------------------------
    |
    ...
    */
    'auth' => [
        ...
        // Add "remember me" to login form 是否展示 保持登录 选项
        'remember' => true,

        // Redirect to the specified URI when user is not authorized. 登录页面 URL
    ...
    */
    'operation_log' => [
        ...
        /*
         * Only logging allowed methods in the list 只记录以下类型的请求
         */
